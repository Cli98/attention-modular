...
def get_train_data(out_folder="./data"):
    ...
    print("Downloading training data, please wait...")
...
def get_vocab_data(out_folder="./data"):
    print("Downloading vocab data, please wait...")
...
def get_dictionary_data(out_folder="./data"):
    print("Downloading dictionary data, please wait...")
...
def get_test_data(out_folder="./data"):
    ...
    print("Downloading testing data, please wait...")
